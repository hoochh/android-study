...
package com.example.receiverapp.databinding;
...
import com.example.receiverapp.R;
...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull Button button,
      @NonNull ImageView imageView, @NonNull TextView tvCharging, @NonNull TextView tvResult) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, button, imageView, tvCharging,
          tvResult);
    }
